...
if (isset($_SESSION["email"])) {
    ...
    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]) ?>" method="POST" enctype="multipart/form-data">
        <div class="container">
            <h1>TU PERFIL</h1>
                        <?php
                $image_path = ".." . DIRECTORY_SEPARATOR . "usuarios" . DIRECTORY_SEPARATOR . $_SESSION["email"] . DIRECTORY_SEPARATOR . "img_perfil" . DIRECTORY_SEPARATOR . "profile_pic.jpg";
                if (file_exists($image_path)) {
                    echo '<img src="' . $image_path . '" alt="Imagen Perfil" width="90px" height="90px" style="border-radius: 15px">';
                }
            ?>
            <p>Bienvenido, <?php echo $atrib_usuario["nombre"]; ?></p>
            ...
            <input type="password" placeholder="Enter Password" name="psw" id="psw" required value="<?php echo "Introduzca su contraseña" ?>">
            ...
            <label for="imag"><b>IMAGEN DE PERFIL</b></label><br><br>
            <div>
                <input type="file" name="imag" id="imag">
                <input id='subirImg' type="submit" name="enviar2" value="Subir Imagen">
            </div>
        ...
        <div id="formulario" class="container">
            <h3>Solicita empleo en nuestra panadería</h3>
            <form action="">
                <!--                <label>Nombre</label>
                                <div class="input">
    ...
    border-radius: 0.5em;" class="page-number" href="profile.php?pag=' . ($i + 1) . '">' . ($i + 1) . '</a>';
                }
            }
            ?>
        </div>
